...
export class SolucionesComponent implements OnInit, AfterViewInit {
  ...
  // public switchSection(label:String) {
  //   this.active.classList.remove('active')
  //   this.show.classList.remove('show')
  //   for (let solucion of this.soluciones) {
  //     switch (solucion) {
  //       case label === this.soluciones[0].label:
  //         this.section01.classList.add('active')
  //         this.section01.classList.add('show')
