...
import { Soluciones } from '../models/solucionesModel/soluciones';
  ...
  private data: Soluciones = {
    Soluciones: [
      ...
      },
      {
        ...
        subTitle:
          'Somos los ojos de tu compañía en puntos de venta, hogares de los consumidores y en donde necesites ver de primera mano.',
      ...
      },
      {
        ...
        subTitle:
          'No es sólo tener datos, es tenerlos organizados para encontrar insight.',
      ...
      },
      {
        ...
        subTitle:
          'El futuro de la investigación de mercados en el mundo: Conocemos lo que gente dice y lo que realmente hace',
      ...
      },
      {
        ...
        subTitle:
          'Cuando el usuario juega con tu marca, aprende mucho más de ella.',
      ...
      },
      {
        ...
        subTitle:
          'Una conversación fluida con tus clientes te genera resultados increíbles',
